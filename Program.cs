...
class Program
{
    static void Main()
    {
        ...
        {
            new User { Name = "Neha", Email = "Neha@example.com", PhoneNumber = "2468631236" },
            new User { Name = "Sumit", Email = "Sumit@example.com", PhoneNumber = "9875434598" },
            new User { Name = "Kartik", Email = "Kartik@example.com", PhoneNumber = "3321733453" },
